        ...
        <div className="mt-14 grid gap-8 lg:grid-cols-3">
          {upcomingEvents.map((event, index) => (
            <motion.div
              ...
              className="overflow-hidden rounded-3xl border border-[#3e4a3e]/10 bg-bg shadow-card"
            >
              ...
              <div className="space-y-4 p-8">
                ...
                <Button href={event.lumaUrl} variant="secondary" className="w-full justify-center border-green/20 text-green">
                  Register on Luma
                </Button>
              </div>
            </motion.div>
          ...
          <div className="mt-14">
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-2">
              {pastEvents.map((event) => (
                <div key={event.id} className="rounded-2xl border border-white/10 bg-panel p-5">
